...
void Input::open_joy()
{
    ...
    if (gamepad)
    {
        ...
        bind_button(SDL_CONTROLLER_BUTTON_LEFTSTICK, 0);		// Digital Controls. Map 'Right Shoulder' to Accelerate
        bind_button(SDL_CONTROLLER_BUTTON_START, 1);			// Digital Controls. Map 'Left Shoulder' to Brake
        ...
        bind_button(SDL_CONTROLLER_BUTTON_RIGHTSTICK, 4);       // Digital Controls. Map 'START'
        bind_button(SDL_CONTROLLER_BUTTON_Y, 5);                // Digital Controls. Map 'Y' to Coin$
        bind_button(SDL_CONTROLLER_BUTTON_LEFTSHOULDER, 6);     // Digital Controls. Map 'Back' to Menu Button
